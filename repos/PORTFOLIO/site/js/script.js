...
// This function will loop through a querySelectorAll to run the click function
for (var i=dropdownTrigger.length; i--;) {
    dropdownTrigger[i].addEventListener('click', dropdown, false);
}*/
...
// ============================================================
/*
var dropdownTrigger = document.querySelector('a.intro-trigger');
...
var dropdown = function(e){
    ...
    if (pageContent.classList) {
	  ...
	  var classes = pageContent.className.split(' ');
	  ...
	  pageContent.className = classes.join(' ');
	}
};

dropdownTrigger.addEventListener('click', dropdown, false);
*/
