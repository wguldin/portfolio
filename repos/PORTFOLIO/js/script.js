...
function formDropdown (value) {
    ...
    switch (value) {
        ...
        case "phone" :
            $('#email').addClass('is-hidden');        
            $('#phone').removeClass('is-hidden');
            ...
            success: function(data) {
                ...
                if (data == "success") {
                    ...
                    $.each( data, function( key, val ) {    
                        $('input[name="' + key + '"]').addClass('error').after('<small class="error" data-validation="error">'+ val +'</small>');
                    });
                }
            },
            error: function(data) {
